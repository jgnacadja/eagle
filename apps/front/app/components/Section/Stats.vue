...
const items = [
  { value: '+250', label: 'formations référencées' },
  { value: '+400', label: 'centres partenaires' },
  { value: '+10 000', label: 'apprenants par an' },
  { value: '4,7<span class="text-base align-top">/5</span>', label: 'satisfaction stagiaires' }
]
</script>
